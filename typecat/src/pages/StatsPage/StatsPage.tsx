  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
        {/* Hero Card */}
        <div className="md:col-span-8 bg-surface-container-lowest border border-outline-variant p-8 rounded-lg relative overflow-hidden group">
          <div className="relative z-10 flex flex-col h-full justify-between">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary text-on-primary rounded-full mb-6">
              ...
              <h1 className="text-3xl font-bold text-primary mb-4">{categoryLabels[category]}</h1>
            ...
            <div className="flex items-center gap-6">
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-xl font-bold text-primary">{totalSessionsCompleted}</span>
                  <span className="text-xs text-on-surface-variant">total</span>
                </div>
              </div>
              <div className="flex flex-col">
                <span className="text-xs text-on-surface-variant">Words Typed</span>
                <span className="text-xl font-bold text-primary">{totalWordsTyped}</span>
              </div>
            </div>
          </div>
        ...
        {/* Stats Panel */}
        <div className="md:col-span-4 bg-surface-container-low border border-outline-variant p-6 rounded-lg flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center border-b border-outline-variant pb-2">
                <span className="text-on-surface-variant">Total Words</span>
          ...
          <div className="mt-8 pt-4 border-t border-outline-variant">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-on-primary">
                <span className="text-[20px] font-bold">{level}</span>
              </div>
              <div>
        ...
        {/* Empty state for chart/history if no sessions */}
        {last10Sessions.length === 0 && (
          <div className="md:col-span-12 bg-surface-container-low border border-outline-variant p-8 rounded-lg text-center">
        ...
        <div className="md:col-span-12 flex flex-col gap-gutter">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
            <div className="bg-secondary-container rounded-lg p-6 flex flex-col items-center text-center relative overflow-hidden group border border-outline-variant">
              <motion.div
                className="text-6xl relative z-10 mb-4"
